...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "4D94F"  # Playfab Title Id
        self.SecretKey: str = "OWTU8J3HOZKFX751K3C33GPIP6TB35HEAQQ6PH8ZCO8NO75I9N"  # Playfab Secret Key
        self.ApiKey: str = "OC|1157985667392416|741ded5acac1c844e6a94d097a091804"  # App Api Key (Oculus/Graph API)
